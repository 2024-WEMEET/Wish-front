  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        onPress={() => navigation.navigate('Major', { tab: '자격증' })}
        >
        ...
        <TouchableOpacity style={styles.card}
        onPress={() => navigation.navigate('Major', { tab: '활동' })}
        >
          <Image source={require('../../assets/main/job.png')} style={styles.cardIcon} />
          <View style={styles.Texts}>
            <Text style={styles.cardText}>활동 알아보기</Text>
            <Text style={styles.SubText}>컴퓨터과학과에서 경험할 수 있는</Text>
            <Text style={styles.SubText}>다양한 활동들에 대해 알려줄게요!</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card}
          onPress={() => navigation.navigate('Major', { tab: '대회' })}        
        >
          <Image source={require('../../assets/main/program.png')} style={styles.cardIcon} />
          <View style={styles.Texts}>
            <Text style={styles.cardText}>대회 도장깨기</Text>
